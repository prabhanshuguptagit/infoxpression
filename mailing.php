    ...
    <body style="background-color:#000000;">
	   ...
	   <div class="signup" style="background-image: url(img/back.png);">
		...
		<option value="">Select Receiver</option>
                            ...
                            <!--button id="submit" type="submit" name="register"><input type="submit" name="register" value="Lets Contact " /> 
							</button-->
							<input id= "submit"type="submit" name="register" value="Lets Contact " /> 
