...
var target_date = new Date('October, 21, 2016').getTime();
...
if(daysContainer){
daysContainer.innerHTML = '<span class="days">' + days + '</span>';
hoursContainer.innerHTML = '<span class="hours">' + hours + '</span>';
minutesContainer.innerHTML = '<span class="minutes">' + minutes + '</span>';
secondsContainer.innerHTML = '<span class="seconds">' + seconds + '</span>';}
